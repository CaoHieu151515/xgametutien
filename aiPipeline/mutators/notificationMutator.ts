 ...
 * with the original game state, and merges them with pre-turn system notifications.
 ...
 * @param preTurnNotifications Notifications generated by the game engine before the AI call.
 * @returns An array of notification strings (can contain HTML).
 */
export const generateAndMergeNotifications = (
    ...
    return [...preTurnNotifications, ...notifications];
};